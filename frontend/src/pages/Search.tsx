...
export default function SearchPage() {
  ...
  return React.createElement('div', { className: 'max-w-3xl mx-auto px-4 py-8' },
    ...
    : posts.length === 0 ? React.createElement('div', { className: 'text-center py-12' },
        ...
        React.createElement('div', { className: 'text-center py-12' }, React.createElement('div', { className: 'text-5xl mb-4' }, '🔍'), React.createElement('h3', { className: 'text-lg font-semibold text-gray-900 mb-2' }, t('no results for') + ' "' + query + '"'), React.createElement('p', { className: 'text-sm text-gray-500 mb-4' }, t('try different keywords')), React.createElement(Link, { to: '/', className: 'text-primary-600 text-sm' }, '\u2190 ' + t('browse all posts'))),
        React.createElement(Link, { to: '/', className: 'text-primary-600 text-sm mt-2 inline-block' }, t('browse all posts'))
      )
