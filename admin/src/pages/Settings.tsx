  ...
  return React.createElement('div', null,
    ...
    tab === 'general' && React.createElement('div', { className: 'card p-6' },
      React.createElement('div', { className: 'grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4' },
        ...
        React.createElement('div', null,
          ...
          React.createElement('p', { className: 'text-xs text-gray-400 mt-1' }, t('site language hint', getLang()))),
        React.createElement('div', null,
          React.createElement('label', { className: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1' }, t('date format', getLang())),
          React.createElement('input', { type: 'text', value: settings.date_format || '', onChange: (e: React.ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, date_format: e.target.value }), className: 'input-field', placeholder: 'Y-m-d' }),
          React.createElement('p', { className: 'text-xs text-gray-400 mt-1' }, t('date format hint', getLang()))),
        // Public registration + developer mode on the same row
        React.createElement('div', null,
          ...
          React.createElement('p', { className: 'text-xs text-gray-400 mt-1' }, t('allow public registration hint', getLang()))),
        React.createElement('div', null,
          React.createElement('label', { className: 'flex items-center gap-2 cursor-pointer text-sm text-gray-700 dark:text-gray-300' },
    ...
    tab === 'tools' && React.createElement('div', { className: 'space-y-4' },
      React.createElement('div', { className: 'card p-6' },
        ...
        cacheInfo && React.createElement('div', { className: 'grid grid-cols-1 sm:grid-cols-[auto_auto_1fr] items-center gap-x-4 gap-y-2 mb-4' },
          React.createElement('div', { className: 'flex items-center gap-2' },
            React.createElement('label', { className: 'flex items-center gap-2 cursor-pointer text-sm text-gray-700 dark:text-gray-300' },
      ...
      React.createElement('div', { className: 'card p-6' },
        ...
        React.createElement('div', { className: 'flex flex-wrap gap-3' },
          ...
          React.createElement('button', { onClick: () => { if (!downloadFile('/db/backup', 'mortar-backup.db')) alert(t('download failed', getLang())); }, className: 'btn-secondary text-sm' }, React.createElement(Download, { size: 14 }), t('download db backup', getLang())),
          React.createElement('button', { onClick: () => { if (!downloadFile('/db/backup-full', 'mortar-backup.zip')) alert(t('download failed', getLang())); }, className: 'btn-secondary text-sm' }, React.createElement(Download, { size: 14 }), t('full backup (zip)', getLang())),
