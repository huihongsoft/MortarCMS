      ...
      React.createElement('div', { className: 'space-y-6' },
        ...
        React.createElement('div', { className: 'card p-5' },
          ...
          React.createElement('div', { className: 'space-y-3' },
            ...
            React.createElement('input', { id: 'profile-pw', type: 'password', className: 'input-field', placeholder: t('new password', getLang()) }),
      ...
      React.createElement('div', { className: 'card overflow-hidden lg:col-span-2' },
        users.length === 0
          ...
          : React.createElement('table', { className: 'w-full' },
              ...
              React.createElement('tbody', null, users.map((u: any) =>
