  ...
  return React.createElement('div', { className: 'min-h-screen flex items-center justify-center bg-gray-100' },
    React.createElement('div', { className: 'w-full max-w-sm card p-8' },
      ...
      resetToken ? React.createElement('form', { onSubmit: handleReset, className: 'space-y-4' },
        ...
        React.createElement('div', null, React.createElement('label', { className: 'block text-sm font-medium text-gray-700 mb-1' }, t('new password', getLang())), React.createElement('input', { type: 'password', autoComplete: 'new-password', value: newPwd, onChange: e => setNewPwd(e.target.value), className: 'input-field', placeholder: '********', required: true })),
        React.createElement('div', null, React.createElement('label', { className: 'block text-sm font-medium text-gray-700 mb-1' }, t('confirm new password', getLang())), React.createElement('input', { type: 'password', autoComplete: 'new-password', value: newPwd2, onChange: e => setNewPwd2(e.target.value), className: 'input-field', placeholder: '********', required: true })),
        ...
        React.createElement('div', null, React.createElement('label', { className: 'block text-sm font-medium text-gray-700 mb-1' }, t('email', getLang())), React.createElement('input', { id: 'login-email', type: 'email', autoComplete: 'username', value: email, onChange: e => setEmail(e.target.value), className: 'input-field', placeholder: 'admin@mortar.dev', required: true })),
        React.createElement('div', null, React.createElement('label', { className: 'block text-sm font-medium text-gray-700 mb-1' }, t('password', getLang())), React.createElement('input', { type: 'password', autoComplete: 'current-password', value: password, onChange: e => setPassword(e.target.value), className: 'input-field', placeholder: t('enter password', getLang()), required: true })),
