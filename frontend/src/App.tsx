  ...
  return React.createElement('div', { className: 'min-h-screen flex flex-col' },
    ...
    React.createElement('main', { className: 'flex-1' },
      React.createElement(Routes, null,
        ...
        React.createElement(Route, { path: '/archive/:year/:month', element: React.createElement(ArchivePage) }),
        React.createElement(Route, { path: '/author/:username', element: React.createElement(AuthorPage) }),
