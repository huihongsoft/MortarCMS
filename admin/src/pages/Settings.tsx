    ...
    tab === 'tools' && React.createElement('div', { className: 'space-y-4' },
      React.createElement('div', { className: 'card p-6' },
        ...
        cacheInfo && React.createElement('div', { className: 'flex flex-wrap items-center gap-4 mb-4' },
          ...
          React.createElement('div', { className: 'flex items-center gap-2' },
            React.createElement('label', { className: 'text-sm text-gray-700 dark:text-gray-300' }, t('cache ttl (seconds)', getLang())),
            React.createElement('input', { type: 'number', min: 5, max: 3600, value: cacheTtl, onChange: (e: React.ChangeEvent<HTMLInputElement>) => setCacheTtl(parseInt(e.target.value) || 60), className: 'input-field w-24 text-sm' })),
