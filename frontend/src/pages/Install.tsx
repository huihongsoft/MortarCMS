      ...
      React.createElement('div', { className: 'card p-8' },
        ...
        step === 1 && React.createElement(React.Fragment, null,
          ...
          dbType !== 'sqlite' && React.createElement('div', { className: 'grid grid-cols-2 gap-3 mt-4' },
            ...
            React.createElement('div', null, React.createElement('label', { className: 'block text-xs font-medium text-gray-600 mb-1' }, t('password')), React.createElement('input', { type: 'password', autoComplete: 'off', value: dbConfig.password, onChange: e => setDbConfig({ ...dbConfig, password: e.target.value }), className: 'input-field' })),
