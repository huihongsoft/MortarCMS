...
rm -rf dist/themes
# frontend/src/themes/<name>/index.ts only — themes without a React layout
# (dark/minimal/newspaper ship theme.json only) are not bundled
THEMES="default magazine aurora twentytwentyfour twentytwentyone twentynineteen twentyseventeen softstore"
for t in $THEMES; do
