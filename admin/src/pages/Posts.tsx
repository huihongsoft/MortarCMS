    ...
    : React.createElement('div', { className: 'card overflow-x-auto' },
        React.createElement('table', { className: 'w-full min-w-[720px]' },
          React.createElement('thead', null, React.createElement('tr', { className: 'border-b border-gray-200 bg-gray-50' },
            ...
            React.createElement('th', { className: 'text-left px-5 py-4 text-xs font-medium text-gray-500 uppercase' }, t('status', getLang())),
            React.createElement('th', { className: 'text-left px-5 py-4 text-xs font-medium text-gray-500 uppercase' }, t('views', getLang())),
